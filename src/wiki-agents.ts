...
export async function compileProjectPage(db: Database.Database, projectName: string): Promise<string> {
  ...
  const prompt = [
    ...
    '',
    'PROCESS — CRAWL broadly across all sources:',
    '1. Call prime_search with "' + projectName + '" to find related items',
    '2. Search for KEY PEOPLE involved in the project by name',
    '3. Search for related COMPANIES or PARTNERS (carriers, brokers, investors)',
    '4. Call prime_get_commitments for this project',
    '5. RETRIEVE at least 5-8 actual sources via prime_retrieve — prioritize meeting transcripts (fireflies, otter), Claude conversations, and recent emails',
    '6. Call prime_entity on the 2-3 most important people',
    '7. Write the wiki page based on what you ACTUALLY READ across ALL source types',
    '',
